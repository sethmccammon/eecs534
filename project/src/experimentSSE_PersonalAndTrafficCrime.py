...
def main():
  ...
  ofile  = open('../results/errorSSE_PersonalAndTraffic.csv', "wb")
  writer = csv.writer(ofile, delimiter=',')
  writer.writerow(["NumberOfBins"]+["TypeOfCrime"]+["PredictedOctoberError"]+["PredictedTestError"]+["PredictedUniformError"]+["UniformOctoberError"]+["UniformTestError"])
  ...
  # #*******************************************************************************************
      ...
      october_map = buildHeatmap(testing_set, num_xbins, num_ybins)
      ...
      writer.writerow([str(number_of_bins)]+[str(type_of_crime)]+[str(heatmapError(october_map, predict_map))]+
      ...
      drawHeatmap(predict_map, "../results/SSE_PersonalAndTraffic_predict"+str(number_of_bins)+".png")
      drawHeatmap(october_map, "../results/SSE_PersonalAndTraffic_october"+str(number_of_bins)+".png")
      drawHeatmap(test_map, "../results/SSE_PersonalAndTraffic_test"+str(number_of_bins)+"_"+".png")
      drawHeatmap(uniform_map, "../results/SSE_PersonalAndTraffic_uniform"+str(number_of_bins)+".png")
