...
def main():
  ...
  for number_of_bins in bins_list:
    ...
    # #*******************************************************************************************
      ...
      drawHeatmap(predict_map, "../results/predictTemp"+str(number_of_bins)+"_"+str(temp)+"_"+".png")
      drawHeatmap(true_map, "../results/trueTemp"+str(number_of_bins)+"_"+str(temp)+"_"+".png")
      drawHeatmap(average_map, "../results/baselineTemp"+str(number_of_bins)+"_"+str(temp)+"_"+".png")
      drawHeatmap(all_crimes_map, "../results/allcrimesTemp"+str(number_of_bins)+"_"+str(temp)+"_"+".png")
