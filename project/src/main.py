...
def main():
	...
	#get the max/min
	# max_x=data[0].x_coordinate
	# max_y=data[0].y_coordinate

	# min_x=data[0].x_coordinate
	# min_y=data[0].y_coordinate
	# print "***",max_x,max_y,"**"
	# print "***",min_x,min_y,"**"

	# for d in data:
	# 	if(d.x_coordinate>max_x):
	# 		max_x=d.x_coordinate
	# 	if(d.y_coordinate>max_y):
	# 		max_y=d.y_coordinate
	# 	if(d.x_coordinate<min_x):
	# 		min_x=d.x_coordinate
	# 	if(d.y_coordinate<min_y):
	# 		min_y=d.y_coordinate
