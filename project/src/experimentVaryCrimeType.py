...
def main():
  ...
  ofile  = open('../results/errorDataVaryCrimeType.csv', "wb")
  ...
  for number_of_bins in bins_list:
    ...
    # #*******************************************************************************************
      ...
      # writer.writerow("NumberOfBins,TypeOfCrime,PredictedOctoberError,BaselineOctoberError,SpecificConditionsVsAllCrimesOctoberError")
      writer.writerow([str(number_of_bins)]+[str(type_of_crime)]+[str(heatmapError(true_map, predict_map))]+
        [str(heatmapError(true_map, average_map))]+[str(heatmapError(all_crimes_map,predict_map))])

      drawHeatmap(predict_map, "../results/predict"+str(number_of_bins)+"_"+str(type_of_crime)+"_"+".png")
      drawHeatmap(true_map, "../results/true"+str(number_of_bins)+"_"+str(type_of_crime)+"_"+".png")
      drawHeatmap(average_map, "../results/baseline"+str(number_of_bins)+"_"+str(type_of_crime)+"_"+".png")
      drawHeatmap(all_crimes_map, "../results/allcrimes"+str(number_of_bins)+"_"+str(type_of_crime)+"_"+".png")
